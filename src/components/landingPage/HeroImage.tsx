  ...
  return (
    <div className="w-full">
         <div className='relative z-50 flex justify-center -mt-8 md:-mt-16 px-2 md:px-4'> 
          ...
          >
            <div className="relative w-full h-[500px] md:h-auto md:aspect-video bg-white dark:bg-zinc-950 rounded-lg md:rounded-xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-border/50 overflow-hidden flex flex-col font-sans">
              <BorderBeam
                size={300}
                duration={15}
                delay={9}
              ...
              <div className="flex flex-1 w-full overflow-hidden relative">
                  ...
                  <div className="relative flex-1 bg-slate-50/50 dark:bg-zinc-950 flex flex-col min-w-0">
                        ...
                        <div className="relative z-10 w-full h-12 md:h-14 border-b border-slate-200/60 dark:border-zinc-800 flex items-center justify-between px-4 md:px-6 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm">
                        ...
                        <div className="relative z-10 flex-1 p-3 md:p-6 grid grid-cols-1 lg:grid-cols-4 gap-4 overflow-hidden">
                            <div className="lg:col-span-3 bg-white dark:bg-zinc-900 rounded-xl shadow-sm border border-slate-200 dark:border-zinc-800 flex flex-col h-full overflow-hidden relative group">
                                <div className="p-3 md:p-4 border-b border-slate-100 dark:border-zinc-800 flex justify-between items-center shrink-0 z-20 relative bg-white dark:bg-zinc-900">
                                    <div className="flex items-center space-x-2">
                                ...
                                <div className="flex-1 relative flex items-center justify-center bg-slate-50/50 dark:bg-zinc-900/50 overflow-hidden min-h-0">
                                     ...
                                     <div className="w-[150%] md:w-full h-full max-w-none md:max-w-2xl px-0 md:px-8 flex items-center justify-center transform-gpu scale-[1.1] md:scale-100 origin-center">
                                        <DotLottieReact
                                            src="/business.lottie" 
                                            loop
                                            autoplay
                                ...
                                <div className="h-10 border-t border-slate-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex items-center px-4 space-x-4 shrink-0 z-20 relative">
